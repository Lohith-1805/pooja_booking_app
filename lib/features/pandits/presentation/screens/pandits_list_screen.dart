            ...
            child: _filteredPandits.isEmpty
                ...
                : ListView.separated(
                    ...
                    itemBuilder: (context, index) =>
                        _PanditCard(pandit: _filteredPandits[index]),
                  ),
          ),
        ],
      ),
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            child: Center(
              child: Text(
                pandit.name.isNotEmpty ? pandit.name.split(' ').last[0] : 'P',
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  spacing: 6,
                  children: pandit.languages.take(3).map((lang) =>
                    Container(
                      padding: const EdgeInsets.symmetric(
                ...
                Row(
                  ...
                  children: [
                    Text(
                      '₹${pandit.basePrice} onwards',
                      style: AppTextStyles.labelLarge
                          .copyWith(color: AppColors.primary),
                    ),
                    ElevatedButton(
                      onPressed: () =>
                          context.push('/pandits/${pandit.id}'),
